...
def create_self_declaration_image(
    ...
    info_lines = [
        f"نام و نام خانوادگی: {session['name']}",
        f"کد ملی: {session['national_id']}",
        f"شماره تماس: {session['phone']}",
        f"تخصص: {session['specialty']}",
        f"سابقه فعالیت: {session['experience']}",
        f"شناسه خوداظهاری: {declaration_id}",
        f"تاریخ و ساعت تأیید: {current_time}"
    ]
...
def process_self_declaration(
    ...
    if step == "national_id":
        ...
        send_message(
            chat_id,
            "📱 شماره تماس ثبت‌شده در آنی‌کار رو وارد کن:"
        )
    ...
    if step == "phone":
        ...
        send_message(
            chat_id,
            "📍 آدرس دقیق محل سکونتت رو وارد کن:"
        )
        ...
        if text == "✅ تأیید و ارسال":
            ...
            if success:
                ...
                send_message(
                    ...
                    "تعهدنامه نهایی به‌صورت تصویر برای "
                    "پشتیبانی آنی‌کار ارسال شد. 💛",
                    main_keyboard()
                )
