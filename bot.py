...
# لینک خود بات برای دعوت از دوستان
...
def send_self_declaration_to_admin(chat_id):
    ...
    if not session:
        ...
        print(
            f"[SELF DECLARATION ERROR] "
            f"No session for {chat_id}"
        )
    ...
    print(
        f"[SELF DECLARATION SEND FAILED] "
        f"chat_id={chat_id}"
    )
...
def process_self_declaration(chat_id, message):
    ...
    if step == "experience":
        ...
        # =================================================
        # ساخت متن نهایی مخصوص همین متخصص
        # =================================================
    ...
    if step == "confirmation":
        ...
        if text == "✅ تأیید و ارسال":
            ...
            # ابتدا اطلاعات را به ادمین می‌فرستیم
            sent = send_self_declaration_to_admin(
                chat_id
            )


            # فقط بعد از تلاش برای ارسال،
            # سشن را پاک می‌کنیم
            self_declaration_sessions.pop(
                chat_id,
                None
            ...
            if sent:
                ...
                send_message(
                    ...
                    "✅ اطلاعات خوداظهاری شما با موفقیت ثبت شد.\n\n"
                    "اطلاعات فرم برای پشتیبانی آنی‌کار "
                    "ارسال شد.\n\n"
                ...
                send_message(
                    ...
                    "⚠️ اطلاعات فرم دریافت شد، اما در "
                    "ارسال آن برای پشتیبانی مشکلی پیش آمد.\n\n"
                    "لطفاً دوباره تلاش کنید یا با پشتیبانی "
                    "آنی‌کار در ارتباط باشید.",
...
def main():
    ...
    print(
        "AnykarHelpBot - Smart Brain فعال شد..."
    )
            ...
            for update in updates:
                ...
                try:
                    ...
                    if (
                        ...
                        reply = (
                            "📤 دعوت از دوستان\n\n"
                            "دستیار هوشمند آنی‌کار رو به "
                            "دوستات معرفی کن. 💛\n\n"
                            "با زدن دکمه زیر وارد بات می‌شن "
                            "و می‌تونن از امکاناتش استفاده کنن.\n\n"
                            "🤖 @anykarhelpbot"
                        )
                    ...
                    if chat_id in support_sessions:
                        ...
                        if step == "service":
                            ...
                            if not text.strip():
                                ...
                                send_message(
                                    chat_id,
                                    "❌ لطفاً نوع خدمت رو وارد کن."
                                )

                                continue


                            session["service"] = text.strip()
                        ...
                        if step == "problem":
                            ...
                            if not text.strip():
                                ...
                                send_message(
                                    chat_id,
                                    "❌ لطفاً مشکل یا درخواستت رو توضیح بده."
                                )

                                continue


                            session["problem"] = text.strip()
                            ...
                            admin_result = send_message(
                                ADMIN_CHAT_ID,
                                support_message
                            )


                            support_sessions.pop(
                                chat_id,
                                None
                            )
                            ...
                            if admin_result and admin_result.get("ok"):
                                ...
                                send_message(
                                    chat_id,
                                    "⚠️ درخواست شما دریافت شد، اما "
                                    "در ارسال آن برای پشتیبانی مشکلی "
                                    "پیش آمد.\n\n"
